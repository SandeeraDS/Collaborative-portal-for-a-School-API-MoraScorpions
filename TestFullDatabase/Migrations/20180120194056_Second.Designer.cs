...
namespace TestFullDatabase.Migrations
{
    ...
    [Migration("20180120194056_Second")]
    partial class Second
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TestFullDatabase.Models.OutlineSyllabus", b =>
                {
            ...
            modelBuilder.Entity("TestFullDatabase.Models.ActionDetails", b =>
                {
                    ...
                    b.HasOne("TestFullDatabase.Models.Principals", "Principal")
                        .WithMany()
            ...
            modelBuilder.Entity("TestFullDatabase.Models.OutlineSyllabus", b =>
                {
                    b.HasOne("TestFullDatabase.Models.ClassRoom", "ClassRoom")
                        .WithMany("SyllabusOfClass")
                        .HasForeignKey("ClassRoomId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TestFullDatabase.Models.Subject", "Subject")
                        .WithMany("SyllabusOfASubject")
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
