...
namespace TestFullDatabase.Migrations
{
    ...
    [Migration("20180122115023_Thirteen")]
    partial class Thirteen
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TestFullDatabase.Models.NoteCommentReply", b =>
                {
            ...
            modelBuilder.Entity("TestFullDatabase.Models.Notice", b =>
                {
                    ...
                    b.Property<bool>("ParentView");

                    b.Property<bool>("StudentView");

                    b.Property<bool>("TeacherView");
            ...
            modelBuilder.Entity("TestFullDatabase.Models.NoteCommentReply", b =>
                {
                    b.HasOne("TestFullDatabase.Models.NoteCommentDetails", "Comments")
                        .WithMany("Replies")
